...
- [Mingw and MSVC Package contents](#mingw-and-msvc-package-contents)
  ...
  - [Microsoft CLonD3D12, Dozen Vulkan, D3D12 VA-API, GLonD3D12 and MFT codecs drivers common dependency](#microsoft-clond3d12-dozen-vulkan-d3d12-va-api-glond3d12-and-mft-codecs-drivers-common-dependency)
...
# Downloads
Mesa 25.3.5 builds with Visual Studio and MSYS2 Mingw-w64 are now available in [releases section](https://github.com/pal1000/mesa-dist-win/releases).
# Sponsorship
...
### Microsoft CLonD3D12, Dozen Vulkan, D3D12 VA-API, GLonD3D12 and MFT codecs drivers common dependency
...
### MFT codecs
File names: `msh264enchmft.dll`, `msh265enchmft.dll` and `msav1enchmft.dll`. Theese codecs debuted in 25.2.0. They can be GPU acccelerated and requuiire D3D12 shhader model 6.9. As consequence they require Windows 11/Server 2025 24H2 (10.0.26100.0) and newer. 
