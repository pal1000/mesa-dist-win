...
# Downloads
Mesa 20.1.0 builds with Visual Studio and MSYS2 Mingw-w64 are now available in [releases section](https://github.com/pal1000/mesa-dist-win/releases).
...
- swr driver [[1](https://gitlab.freedesktop.org/mesa/mesa/merge_requests/362#note_130059)][[2](https://ci.appveyor.com/project/Alexpux/mingw-packages/builds/23168385/job/xx1p90m245mmhgkk)] and [osmesa classic](https://gitlab.freedesktop.org/mesa/mesa/issues/2297) are not available due to build failure.
