...
@git checkout .
@echo.
@set buildconf=meson build/%abi% --default-library=static --buildtype=release --cross-file=%devroot:\=/%/mesa-dist-win/buildscript/mesonconfig/%abi%-clang.txt -Dllvm=false
