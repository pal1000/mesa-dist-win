...
@IF /I "%msyscmd%"=="setup" set msyscmd=pacman -S flex bison patch tar mingw-w64-i686-python-mako mingw-w64-i686-meson mingw-w64-i686-pkg-config mingw-w64-i686-clang mingw-w64-x86_64-python-mako mingw-w64-x86_64-meson mingw-w64-x86_64-pkg-config mingw-w64-x86_64-clang --needed
