...
@IF /I "%msyscmd%"=="setup" set msyscmd=pacman -S flex bison patch tar mingw-w64-i686-{python-mako,meson,pkgconf,llvm,gcc,vulkan-devel,gdb} mingw-w64-x86_64-{python-mako,meson,pkgconf,llvm,gcc,vulkan-devel,gdb} --needed;echo;read -n 1 -s -r -p 'Press any key to continue';echo;echo;pacman -Sc --noconfirm
