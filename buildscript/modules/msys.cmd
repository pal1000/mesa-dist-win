...
@set mingwpkglst={cc,clang,cmake,dlfcn,directx-headers,gdb,glslang,libelf,libpng,libva,llvm,meson,mman-win32,pkgconf,polly,python-mako,python-packaging,python-yaml,sdl3,spirv-headers,spirv-llvm-translator,spirv-tools,vulkan-headers,vulkan-loader,zstd}