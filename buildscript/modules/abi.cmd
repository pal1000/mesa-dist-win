...
@if %cpuchoice% EQU 3 set abi=arm64
...
@IF %abi%==arm64 set MSYSTEM=CLANGARM64
@IF %abi%==arm64 set LMSYSTEM=clangarm64
...
@IF /I %PROCESSOR_ARCHITECTURE%==ARM64 set hostabi=arm64
