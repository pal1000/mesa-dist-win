...
@IF %pythonver:~0,1% GEQ 3 IF NOT EXIST %devroot%\mesa echo 2. Meson (experimental)
@IF %pythonver:~0,1% GEQ 3 IF EXIST %devroot%\mesa\subprojects\.gitignore echo 2. Meson (experimental)
@IF %pythonver:~0,1% GEQ 3 echo.
