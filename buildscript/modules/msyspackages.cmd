...
@%msysloc%\usr\bin\bash --login -c "/usr/bin/pacman -S ${MINGW_PACKAGE_PREFIX}-python-mako ${MINGW_PACKAGE_PREFIX}-meson ${MINGW_PACKAGE_PREFIX}-pkgconf flex bison patch tar --needed --noconfirm --disable-download-timeout"
@echo.
