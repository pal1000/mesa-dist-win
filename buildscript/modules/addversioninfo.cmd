...
@call "%devroot%\%projectname%\buildscript\modules\rcgen.cmd" "Microsoft OpenCL over D3D12 driver" "%devroot%\%projectname%\bin\%abi%\openclon12.dll" %abi% 2022.6.28 "Microsoft Corporation"
