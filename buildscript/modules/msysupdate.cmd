...
@%msysloc%\usr\bin\bash --login -c "/usr/bin/pacman -Syuu --disable-download-timeout"
@echo.
...
@IF /I "%msysupdate%"=="y" %msysloc%\usr\bin\bash --login -c "/usr/bin/pacman -Syuu --disable-download-timeout"
