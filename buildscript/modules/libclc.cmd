...
@md buildsys-clc
@cd buildsys-clc
@set buildconf=cmake "%devroot%\llvm-project\libclc" -GNinja -DCMAKE_SYSTEM_VERSION="%WINSDK_VER%" -DCMAKE_BUILD_TYPE=Release -DCMAKE_CXX_FLAGS="-m64" -DCMAKE_MSVC_RUNTIME_LIBRARY=MultiThreaded -DCMAKE_INSTALL_PREFIX="%llvminstloc%\clc" -DLIBCLC_TARGETS_TO_BUILD="spirv-mesa3d-;spirv64-mesa3d-" -DCMAKE_PREFIX_PATH="%llvminstloc%\%hostabi%" -DLLVM_SPIRV="%llvminstloc%\spv-%hostabi%\bin\llvm-spirv.exe"
