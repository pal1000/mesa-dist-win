...
@IF %intmesaver% GEQ 21300 call %devroot%\%projectname%\buildscript\modules\applypatch.cmd swr-msvc-2
...
@IF %intmesaver:~0,3% EQU 213 call %devroot%\%projectname%\buildscript\modules\applypatch.cmd radv-msvc-llvm13
...
@IF %toolchain%==msvc IF %disableootpatch%==1 IF %intmesaver% LSS 22000 set canradv=0
